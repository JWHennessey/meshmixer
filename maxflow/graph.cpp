...
#warning "*************** GRAPH CPP INCLUDED ********************"

template < typename M, typename captype, typename tcaptype, typename flowtype> 
	Graph<M, captype, tcaptype, flowtype>::Graph(int node_num_max, int edge_num_max, void (*err_function)(char const*))
	: node_num(0),
	  nodeptr_block(NULL),
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
	Graph<M, captype,tcaptype,flowtype>::~Graph()
{
	if (nodeptr_block) 
	{ 
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
	void Graph<M, captype,tcaptype,flowtype>::reset()
{
	node_last = nodes;
	arc_last = arcs;
	node_num = 0;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
	void Graph<M, captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
	void Graph<M, captype,tcaptype,flowtype>::reallocate_arcs()
{
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
inline void Graph<M, captype,tcaptype,flowtype>::set_active(node *i)
{
  if (!i->next)
    {
...
*/
template < typename M, typename captype, typename tcaptype, typename flowtype> 
inline typename Graph<M, captype,tcaptype,flowtype>::node* Graph<M, captype,tcaptype,flowtype>::next_active()
{
  node *i;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
inline void Graph<M, captype,tcaptype,flowtype>::set_orphan_front(node *i)
{
  nodeptr *np;
  i -> parent = ORPHAN;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
inline void Graph<M, captype,tcaptype,flowtype>::set_orphan_rear(node *i)
{
  nodeptr *np;
  i -> parent = ORPHAN;
  np = nodeptr_block -> New();
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
inline void Graph<M, captype,tcaptype,flowtype>::add_to_changed_list(node *i)
{
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::maxflow_init()
{
  node *i;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::maxflow_reuse_trees_init()
{
  node* i;
  node* j;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::augment(arc *middle_arc)
{
  node *i;
  arc *a;
  tcaptype bottleneck;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::process_source_orphan(node *i)
{
  node *j;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::process_sink_orphan(node *i)
{
  node *j;
  arc *a0, *a0_min = NULL, *a;
  int d, d_min = INFINITE_D;
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
flowtype Graph<M, captype,tcaptype,flowtype>::maxflow(bool reuse_trees, MyBlock<node_id>* _changed_list)
{
...
template < typename M, typename captype, typename tcaptype, typename flowtype> 
void Graph<M, captype,tcaptype,flowtype>::test_consistency(node* current_node)
{
  node *i;
  arc *a;
  int r;
